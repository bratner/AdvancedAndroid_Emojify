...
class Emojifier {
    ...
    public static void getClassifications(Face face) {
        Log.d(LOG_TAG, "Right eye: "+face.getIsRightEyeOpenProbability());
        Log.d(LOG_TAG, "Left eye: "+face.getIsLeftEyeOpenProbability());
        Log.d(LOG_TAG, "Smiling: "+face.getIsSmilingProbability());
